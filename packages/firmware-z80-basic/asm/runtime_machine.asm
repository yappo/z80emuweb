...
CMD_LOCATE_HANDLER:
  ...
  OUT (LCD_CMD_PORT),A
  LD A,E
CMD_LOCATE_COL_MOD24:
  CP 24
  JR C,CMD_LOCATE_COL_STORE
  SUB 24
  JR CMD_LOCATE_COL_MOD24
CMD_LOCATE_COL_STORE:
  LD (RAM_TEXT_COL),A
...
OUT_PORT_58: LD A,D
  OUT (0x58),A
  CP 0x01
  JR Z,OUT_PORT_58_CLS
  BIT 7,A
  RET Z
  AND 0x7F
OUT_PORT_58_MOD24:
  CP 24
  JR C,OUT_PORT_58_STORE
  SUB 24
  JR OUT_PORT_58_MOD24
OUT_PORT_58_STORE:
  LD (RAM_TEXT_COL),A
  RET
OUT_PORT_58_CLS:
