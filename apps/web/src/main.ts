...
SHOULD_DRAW_LEFT_SEAM_AT_DEPTH:
  ...
  LD A,(SCENE_NEAR_LEFT_OPEN)
  OR A
  JR Z,SHOULD_DRAW_LEFT_SEAM_LOOP_START
  XOR A
  RET
SHOULD_DRAW_LEFT_SEAM_LOOP_START:
  LD A,1
SHOULD_DRAW_LEFT_SEAM_LOOP:
  CP B
  JR NC,SHOULD_DRAW_LEFT_SEAM_TRUE
  LD C,A
  CALL LOAD_LEFT_FLAG
  OR A
  LD A,C
  JR NZ,SHOULD_DRAW_LEFT_SEAM_FALSE
  INC A
  JR SHOULD_DRAW_LEFT_SEAM_LOOP
...
SHOULD_DRAW_RIGHT_SEAM_AT_DEPTH:
  ...
  LD A,(SCENE_NEAR_RIGHT_OPEN)
  OR A
  JR Z,SHOULD_DRAW_RIGHT_SEAM_LOOP_START
  XOR A
  RET
SHOULD_DRAW_RIGHT_SEAM_LOOP_START:
  LD A,1
SHOULD_DRAW_RIGHT_SEAM_LOOP:
  CP B
  JR NC,SHOULD_DRAW_RIGHT_SEAM_TRUE
  LD C,A
  CALL LOAD_RIGHT_FLAG
  OR A
  LD A,C
  JR NZ,SHOULD_DRAW_RIGHT_SEAM_FALSE
  INC A
  JR SHOULD_DRAW_RIGHT_SEAM_LOOP
...
COMPUTE_FRONT_CLIP:
  ...
  LD A,(SCENE_FIRST_LEFT_OPEN_DEPTH)
  OR A
...
COMPUTE_FRONT_CLIP_RIGHT:
  LD A,(SCENE_FIRST_RIGHT_OPEN_DEPTH)
  OR A
