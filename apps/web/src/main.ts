...
BUFFER:
  DS 12,0`;
const ASM_SAMPLE_3D = `ORG 0x0100
ENTRY START
...
DRAW_LEFT_BRANCH_AT_DEPTH:
  ...
  LD A,(RECT_INDEX)
  CP B
  JR NC,DRAW_LEFT_BRANCH_HAVE_OUTER
  XOR A
...
DRAW_RIGHT_BRANCH_AT_DEPTH:
  ...
  LD A,(RECT_INDEX)
  CP B
  JR NC,DRAW_RIGHT_BRANCH_HAVE_OUTER
  XOR A
