...
7090 GOSUB 7600
7100 LET C=INP(18)
7110 IF C=32 THEN 7300
7120 OUT 16,7
7130 LET R=INP(17)
7140 IF R=239 THEN 7300
7150 LET CT=CT+1
7160 IF CT<3 THEN 7260
7170 LET CT=0
7180 IF BL=0 THEN 7200
7190 LET BL=0
7195 GOSUB 7800
7196 GOTO 7260
7200 LET BL=1
...
9590 GOSUB 7600
9600 LET C=INP(18)
9610 IF C=32 THEN 9800
9620 OUT 16,7
9630 LET R=INP(17)
9640 IF R=239 THEN 9800
9650 LET CT=CT+1
9660 IF CT<3 THEN 9750
9670 LET CT=0
9680 IF BL=0 THEN 9720
9690 LET BL=0
9700 GOSUB 7800
9710 GOTO 9750
9720 LET BL=1
...
9800 RETURN
9000 CLS
9010 PRINT "ALL STAGE CLEAR!"
9020 PRINT "FINAL SCORE:";S
9030 END`;
