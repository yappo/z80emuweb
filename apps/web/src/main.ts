...
100 GOSUB 6000
110 LET SE=INP(18)+INP(17)+PEEK(0)
120 IF SE<>0 THEN 140
130 LET SE=37
140 GOSUB 2000
150 LET X=1
160 LET Y=1
...
6000 CLS
6010 LOCATE 0,0
6020 PRINT "     MASE 4X4 GAME !"
6030 LOCATE 0,1
6040 PRINT "  &=YOU #=WALL Key Goal"
6050 LOCATE 0,2
6060 PRINT "   USE: WASD OR ARROWS"
6070 LET BL=1
6080 LET CT=0
6090 GOSUB 6700
6100 LET C=INP(18)
6110 IF C=32 THEN 6300
6120 OUT 16,7
6130 LET R=INP(17)
6140 IF R=239 THEN 6300
6150 LET CT=CT+1
6160 IF CT<3 THEN 6220
6170 LET CT=0
6180 IF BL=0 THEN 6250
6190 LET BL=0
6200 GOSUB 7000
6210 GOTO 6220
6220 WAIT 16
